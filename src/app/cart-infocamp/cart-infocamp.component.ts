...
@Component({
  selector: 'app-cart-infocamp',
  standalone:true,
  imports:[CommonModule],
  templateUrl: './cart-infocamp.component.html',
  styleUrls: ['./cart-infocamp.component.css']
})
export class CartInfocampComponent implements OnInit {
